...
class Asteroids : public GameSession, public IKeyboardListener,
    public IGameWorldListener, public IScoreListener, public IPlayerListener
{
public:
    ...
    void OnLifeGained(int lives_total);
...
private:
    ...
    void CreateWeaponUpgradePowerup();
    ...
    const static uint SPAWN_WEAPON = 5;
